...
void qdp_vaxpby_chp( char *);
void qdp_vaxpby_chm( char *);
...
/* qdp_vaxpby_chp(y, a, x, y, n_4vec)
 *
 * Operation: z = a x +/- (1/2)(1 + g5) b y
 *
...
/* qdp_vaxpby_chm(z, a, x, b, y, n_4vec)
 *
 * Operation: y = a *x +  (1/2)(1 - g5) b * x
 * 
 *  g5 is in chiral basis diag(1,1,-1, -1)
